...
- (void)viewDidLoad
{
    ...
    self.lbl_contact_info.text = @"+1.303.500.3821";//medInfo.phone;
    self.lbl_contact_email.text = @"info@placidway.com";//medInfo.phone;
...
-(IBAction)makeCall
{
    NSString *phoneNumber = [@"telprompt://" stringByAppendingString:self.lbl_contact_info.text];
